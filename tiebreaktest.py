...
FILEPATH = str(Path(__file__).parent.parent.absolute()) + "/unittest/testfiles/"
...
TESTFILES = {
    "test1": {
        "type": "S",
        "team": False,
        "input_file": "test1.trf",
    },
    "rrheld": {
        "type": "R",
        "team": False,
        "input_file": "Round-Robin-Example.trf",
    },
    "t6681": {
        "type": "R",
        "team": False,
        "input_file": "t6681.trf",
    },
    "swiss5held": {
        "type": "S",
        "team": False,
        "input_file": "Swiss-5-Example.trf",
    },
    "swiss9held": {
        "type": "S",
        "team": False,
        "input_file": "Swiss-9-Example.trf",
    },
    "nmunm24": {
        "type": "S",
        "team": False,
